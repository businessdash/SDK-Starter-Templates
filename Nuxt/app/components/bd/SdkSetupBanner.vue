 ...
 * NUXT_PUBLIC_BD_SITE_ID + NUXT_PUBLIC_BD_PK are set (read here off
...
const baseUrl =
	(config.public.bdPackageApiBaseUrl as string | undefined) ||
	"https://www.biab.app";
...
<template>
	<div v-if="visible" class="bd-setup">
		<span class="bd-setup__text">
