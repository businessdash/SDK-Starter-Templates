...
/**
 * POST /api/bd/portal/submit-review  { rating, title?, body, jobId? }
 *
 * Submit a review as the signed-in customer via the BD portal. Reads the
 * `bd_session` cookie (forwarded through `Astro.cookies`) to authorise the
