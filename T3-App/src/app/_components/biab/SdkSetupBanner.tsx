 ...
 * NEXT_PUBLIC_BIAB_SITE_ID + NEXT_PUBLIC_BIAB_PK are set (values are inlined at
 * build time), and can be dismissed for this browser in the meantime.
 */

// Inlined at build time. When unset, the site is running unconfigured.
const SITE_ID = process.env.NEXT_PUBLIC_BIAB_SITE_ID;
const PK = process.env.NEXT_PUBLIC_BIAB_PK;
const BASE_URL =
  process.env.NEXT_PUBLIC_BIAB_PACKAGE_API_BASE_URL ?? "https://www.biab.app";
