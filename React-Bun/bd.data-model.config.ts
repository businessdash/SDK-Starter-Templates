/**
 * BD starter — custom-database data model (relational Todos demo).
 *
 ...
 *
 *   1. `bun run sync-data-model` — pushes this model (plus the auto-generated
 *      create-form drafts) to BD's draft slot. Nothing changes until a human
