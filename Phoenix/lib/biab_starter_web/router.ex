defmodule BiabStarterWeb.Router do
  use BiabStarterWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BiabStarterWeb.Layouts, :root}
  ...
  scope "/", BiabStarterWeb do
    ...
    get "/api/biab-auth/:action", BiabAuthController, :handle
    post "/api/biab-auth/:action", BiabAuthController, :handle
  ...
  scope "/", BiabStarterWeb do
    ...
    get "/api/biab/forms/:slug", BiabFormController, :schema
    post "/api/biab/forms/:slug", BiabFormController, :submit
  end

  scope "/", BiabStarterWeb do
    pipe_through :webhook
    post "/api/biab/revalidate", WebhookController, :handle
  end
