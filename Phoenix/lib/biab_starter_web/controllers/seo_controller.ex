defmodule BiabStarterWeb.SeoController do
  ...
  defp host, do: String.trim_trailing(Application.get_env(:biab_starter, :biab_host, ""), "/")
  defp origin, do: String.trim_trailing(Application.get_env(:biab_starter, :biab_site_origin, ""), "/")
  defp site_id, do: Application.get_env(:biab_starter, :biab_site_id)
  defp api_key, do: Application.get_env(:biab_starter, :biab_api_key)
end
