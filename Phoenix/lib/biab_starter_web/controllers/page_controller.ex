defmodule BiabStarterWeb.PageController do
  ...
  def home(conn, _params) do
    render(conn, :home,
      bundle: Biab.page_bundle("home"),
      products: Biab.featured_products(6),
      posts: Biab.posts(3)
    )
  end
  ...
  def reviews(conn, params) do
    ...
    render(conn, :reviews, reviews: Biab.reviews(10, offset), offset: offset)
  end

  def updates(conn, _params) do
    render(conn, :updates, updates: Map.get(Biab.page_bundle("home"), "updates", []))
  end
  ...
  def subscribe(conn, params) do
    ...
    flash =
      if valid_email?(email) do
        case Biab.follower_join(email, Map.get(params, "name")) do
