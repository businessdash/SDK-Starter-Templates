defmodule BiabStarter.Biab.Socials do
  @moduledoc """
  ...
  The platform table itself is generated from `biab-dev/src/socials.ts` (see
  `BiabStarter.Biab.SocialPlatforms`), so adding a platform upstream reaches
  every language at once.
  """

  alias BiabStarter.Biab.SocialPlatforms
