defmodule BiabStarter.Biab.Client do
  @moduledoc """
  ...
  Returns `nil` when BIAB isn't configured. That is a supported state, not an
  ...
  def new do
    ...
    if host && key && site_id do
      %{
        ...
        api_key: key,
        site_id: site_id,
        origin: String.trim_trailing(env(:biab_site_origin) || "", "/")
      }
    end
  end
  ...
  defp env(key) do
    case Application.get_env(:biab_starter, key) do
