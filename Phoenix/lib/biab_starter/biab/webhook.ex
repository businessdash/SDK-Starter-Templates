defmodule BiabStarter.Biab.Webhook do
  @moduledoc """
  ...
  Three rules, each silent when broken:
    ...
    1. Verify against the **raw** body, byte for byte. `Jason.decode` then
       ...
       — see `BiabStarterWeb.Plugs.CacheBodyReader`. This is the single most
  ...
  def verify(raw_body, signature_header, secret \\ nil) do
    secret = secret || Application.get_env(:biab_starter, :biab_revalidation_secret)
