defmodule BdStarterWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :bd_starter

  @session_options [
    store: :cookie,
    key: "_bd_starter_key",
    signing_salt: "bd-starter",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    ...
    from: :bd_starter,
    gzip: false,
    only: BdStarterWeb.static_paths()
