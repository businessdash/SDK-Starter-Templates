...
public actor BiabSessionStore {
    private let service: String
    private let account = "biab.session-token"
    private let visitorDefaultsKey = "biab.cart-visitor-token"
    private let defaults: UserDefaults

    public init(service: String = "app.biab.session", defaults: UserDefaults = .standard) {
