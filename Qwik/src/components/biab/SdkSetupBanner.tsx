 ...
 * PUBLIC_BIAB_SITE_ID + PUBLIC_BIAB_PK are set (browser-exposed via
 * Vite's envPrefix, see vite.config.ts), and can be dismissed for this browser
 * meanwhile.
 *
 * Canonical `PUBLIC_BIAB_*` names are preferred; the starter's original
 * `PUBLIC_BIAB_*` names still work as a fallback.
 */
