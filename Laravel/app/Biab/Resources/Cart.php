...
/**
 * Server-side cart. All state lives at BIAB — this app only holds the
 * visitor token, in an httpOnly cookie, so a cart survives a page load
 * without any of it living in the browser.
 *
 * Anonymous visitor: `X-BIAB-Cart-Visitor`.
 * Signed-in customer: `X-BIAB-Session-Token` (carts merge on sign-in).
 */
class Cart
{
