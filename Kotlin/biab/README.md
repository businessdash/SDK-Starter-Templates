...
```kotlin
implementation("us.businessdash:sdk:0.9.70")
```
...
```kotlin
val client = BiabClient(baseUrl = BASE_URL, apiKey = API_KEY)
...
```sh
./gradlew :biab:publishAllPublicationsToCentralPortalRepository
```
