...
public fun BiabClient.chat(sessionId: String, visitorToken: String): ChatFeed =
    ChatFeed(this, sessionId, visitorToken)

/** Mint (or resume) a Front Desk session, then hand back a feed bound to it. */
public suspend fun BiabClient.startChat(visitorToken: String): ChatFeed {
