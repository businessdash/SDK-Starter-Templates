 ...
 *
 * Wired to BIAB followers via a **publishable** token (`pk_…`, origin-locked,
...
const BIAB_PK = import.meta.env["VITE_BIAB_PK"] as string | undefined;
const BIAB_SITE_ID = import.meta.env["VITE_BIAB_SITE_ID"] as string | undefined;
const BIAB_BASE_URL = import.meta.env["VITE_BIAB_PACKAGE_API_BASE_URL"] as
	| string
	| undefined;
...
export function Subscribe(props: SubscribeProps) {
	if (BIAB_FOLLOWERS_ENABLED) return <LiveSubscribe {...props} />;
